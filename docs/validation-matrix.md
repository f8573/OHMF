...
Status: Stage A complete. Stage B1 now has per-user limiter evidence, per-IP limiter evidence, and a unique-tag rerun ladder that passed 75/90/105 msg/sec with exact processor-stage reconciliation and failed at 120 msg/sec for 600s. Stages B2-D remain not yet run.
