...
Status: Stage A complete. Stage B1 attempted and failed. Later stages remain not yet run.
...
| Sustained local throughput claim | not supported by current evidence | [2026-06-08-sustained-120msgsec](C:/Users/James/Downloads/Messages/benchmarks/results/2026-06-08-sustained-120msgsec/summary.md) | Clean target run accepted `419/14400` only; the committed single-sender driver hit gateway `http_429` throttling and did not substantiate `120 accepted msg/sec` |
